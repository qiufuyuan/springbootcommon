package com.wanbaolot.terminal.plugin;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/wanbaolot?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.wanbaolot.terminal");
